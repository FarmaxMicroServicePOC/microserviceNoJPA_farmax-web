		...
		<main>
		    ...
		    <div class="container">
		        ...
		        <div id="userDiv" class="row">
		            ...
		            <div class="col-md-5">
		            	<div class="form-group">
							<label for="card">IP Address:</label>
				...
				<div id="cartDiv" class="row">
				    <h2 class="h2-responsive">Orders</h2>
				    <div class="card-block">
					    <div class="row">
						    <div class="col-xs-7 col-sm-9">
						    	<a href="#" data-index="0" data-product-type="IP address" data-name="IP Address">IP Address</a>
						    </div>
					    </div>
					    <div class="row">
					    	<div class="col-xs-7 col-sm-9">
					    		<div class="small" id="ipAddress">192.168.56.1</div>
					    	</div>
					    </div>
				    </div>
